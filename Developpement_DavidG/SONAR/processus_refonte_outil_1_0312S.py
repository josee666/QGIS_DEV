...
def main():
    ...
    processing.run("native:fixgeometries", {'INPUT':path_PeupForestiers,
                                            'OUTPUT':'ogr:dbname=\'C:/MrnMicro/temp/grille.gpkg\' table=\"PeupForestiersFix\" (geom)'})

    path_PeupForestiersFix = 'C:/MrnMicro/temp/grille.gpkg|layername=PeupForestiersFix'
