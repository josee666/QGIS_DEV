...
class PreparationIntrantsAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        path_us_buf_2km = 'ogr:dbname=\'{0}\' table=\"us_buf_2km_{1}\" (geom) sql='.format(gpkg,us)

        # # copie l'us dans le geopackage
        # # Copie des peuplement dans le GPKG
        # us_gpkg = 'us'
        # path_us = copyCeToGpkg(path_us, gpkg, us_gpkg)

        # # faire un dissolve de l'US
        # dissolvedGeopandasGPKG(gpkg, us_gpkg, 'us_dissolve', fields = None)


        # Faire le dissolve a qgis. Par contre, il faut auparavant que Robin s'assure qu'il n'est pas de trou.
        # Pour ce faire j'ai fait un extent de l'us et un clip dans arcmap et ca regle les problemes.
        # C'est comme si l'extration ce fait ave des tolerance tres petites. C'est pour ca que la couche est plein de trou dans QGIS
