...
from .sptialJoinLargestOverlap_provider import sptialJoinLargestOverlapProvider
...
class sptialJoinLargestOverlapPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = sptialJoinLargestOverlapProvider()
